window.CONTENIDO = {
  "portada": {
    "kicker": "Análisis de partidos • Táctica • Futuras estrellas",
    "titulo": "Cada partido enseña algo.\nYo lo apunto.",
    "subtitulo": "¡Hola! Soy Álvaro. Cada semana veo fútbol, aprendo algo nuevo y comparto lo que descubro.",
    "boton": "Leer mis minutos"
  },
  "notas": [
    {
      "numero": 27,
  ...
  "temas": [
    {
      "titulo": "📋 Análisis de partidos",
      "texto": "No solo el resultado: por qué un equipo dominó el centro del campo y dónde se ganó y se perdió el partido."
    },
    {
      "titulo": "🧠 Táctica",
      "texto": "Formaciones, presión, salida de balón... las ideas detrás del juego, explicadas de forma sencilla."
    },
    {
      "titulo": "⭐ Futuras estrellas",
      "texto": "Jóvenes talentos a los que seguir antes de que todo el mundo conozca su nombre."
    }
  ],
  "sobreMi": {
  ...
  "pie": {
    "lema": "Aprendiendo el juego. Compartiendo el juego."
  }
};
